...
export  const ProgramRowItem = ({ icon, title, sessions, ages, locations, price }: any) => (
  <div className="bg-white p-4 rounded-2xl flex items-center justify-between border border-gray-100 hover:shadow-md transition-all group cursor-pointer">
    ...
    <div className="flex items-center gap-6">
      <div className="text-right">
        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-tighter">Starts at</p>
